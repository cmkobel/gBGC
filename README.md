...
The conclusion then must be that ClonalFrameML has more power than PHI. And also, as stated in the ClonalFrameML paper - ClonalFrameML has a tendency to underestimate values of high R/theta.
